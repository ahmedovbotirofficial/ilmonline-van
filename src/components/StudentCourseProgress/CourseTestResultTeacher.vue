  ...
  <div class="current_test_main_wrapper">
    <div class="container">
      <div class="current_test_main">
        ...
        <div v-if="!!getRightLessonTestAnswers" class="current_test_choose">
...
export default {
  ...
  computed: {
    ...
    correctAnswersPercent() {
      return (this.correctAnswers / this.getLessonTest.questions_count) * 100;
    },
  ...
  methods: {
    ...
    getBadAnswers(question_id, answer_id) {
      return (
        this.getLessonTestProgress.find((el) => el.question_id === question_id)
          .answer_id === answer_id
      );
    },
